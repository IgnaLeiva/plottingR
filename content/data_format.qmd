...
If you need to work with factor/categoric using a different names or levels, and additionally you want to change the name of your variables, you could do this. (Remember that in R there are several ways to achieve the same result).
...
The table can be exporeted as `docx` for that a bit of additional coding.
